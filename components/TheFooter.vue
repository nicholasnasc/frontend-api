    ...
    <div class="max-w-7xl border-l border-r border-dashed border-gray-700 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-sm leading-6 text-gray-400 md:mt-0 md:order-1">
         <a href="https://discloud.app/">{{ $config.name }}</a> © 2022 ─ Desenvolvido com muito açaí por <span class="ceator-preview hover:text-hot-pink text-gray-300">
          <a class="hidden md:inline-block" rel="noreferrer" target="_blank" href="https://github.com/DisCloud">
          <creator-preview
            :avatar="avatar"
            :name="name"
          ...
          <a class="inline-block md:hidden" target="_blank" href="https://github.com/DisCloud">{{ name }} </a>
          </span>
        </p>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      avatar: 'images/post/nick.png',
      name: 'Nickolas#7178',
      mode: 'dark',
      description: 'Manager, Software Engineer.',
      content: `Fique por dentro de todas as atualizações da nossa API, criamos um fórum em nosso servidor para que você possa tirar todas as dúvidas que surgirem, confira o link abaixo:<br/><br/>
        <a href="https://discord.gg/CvxevT5"><b>Clique aqui 😄</b></a>`,
    }
  }
}
</script>
